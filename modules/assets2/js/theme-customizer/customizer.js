...
var whatsapp_support = "<?= $card->whatsapp_support ?>";
...
(function ($) {
  ...
  $(document).ready(function () {
    $(".customizer-color li").on("click", function () {
      ...
      $("#color").attr("href", "modules/assets2/css/" + color + ".css");
    ...
    $(".sidebar-type li").on("click", function () {
      ...
      switch (type) {
        ...
        case "normal-sidebar": {
          ...
          $(".logo-wrapper")
            .find("img")
            .attr("src", "modules/assets2/images/logo/logo.png");
